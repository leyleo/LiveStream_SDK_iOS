#
#  Be sure to run `pod spec lint LiveStreamSDK.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "liuley"
  # s.authors            = { "liuley" => "liuley@163.com" }
  # s.social_media_url   = "http://twitter.com/liuley"
  ...
  s.source_files  = "LiveStreamSDK/**/*.m*"
  s.exclude_files = "LiveStreamSDK/LSDemo"
